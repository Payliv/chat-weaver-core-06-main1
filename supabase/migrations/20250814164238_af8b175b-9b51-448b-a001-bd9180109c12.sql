-- Create tables for SaaS generator contextual memory and project management

-- Table for storing generated apps with full context
...
CREATE TABLE public.saas_templates (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID NOT NULL,
...
CREATE INDEX idx_generated_apps_created_at ON public.generated_apps(created_at DESC);
CREATE INDEX idx_user_preferences_user_id ON public.user_preferences(user_id);
CREATE INDEX idx_saas_templates_user_id ON public.saas_templates(user_id);
CREATE INDEX idx_saas_templates_public ON public.saas_templates(is_public) WHERE is_public = true;